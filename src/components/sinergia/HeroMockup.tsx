      ...
      >
        <div className="glass-card rounded-2xl border-t border-white/10 shadow-2xl overflow-hidden aspect-video relative bg-slate-900/50 backdrop-blur-3xl flex">
          ...
          <motion.div 
            ...
            className="absolute bottom-8 right-[-20px] md:right-8 glass-card bg-slate-900/90 rounded-2xl p-4 border border-white/10 shadow-2xl flex items-center gap-4 w-72 z-20"
          >
